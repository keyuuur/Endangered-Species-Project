...
function posterHtmlCss_() {
  return [
    ...
    '.status-card h2{font-size:27px;color:', POSTER_HTML_V1.greenDark, ';margin-top:.69in;}',
    ...
    '.biome-card h2{font-size:24px;color:', POSTER_HTML_V1.teal, ';margin-top:.71in;}',
    ...
    '.threats-card h2{font-size:28px;color:', POSTER_HTML_V1.coralDark, ';margin-top:.69in;}',
    '.help-card h2{font-size:21px;color:', POSTER_HTML_V1.greenDark, ';margin-top:.69in;}',
    '.why-card h2{font-size:22px;color:', POSTER_HTML_V1.blueDark, ';margin-top:.69in;}',
    '.icon-circle{position:absolute;z-index:3;left:50%;top:.1in;transform:translateX(-50%);width:.5in;height:.5in;border-radius:999px;background:#fff;border:3px solid currentColor;text-align:center;line-height:.5in;}',
    '.icon-circle svg{width:.32in;height:.32in;vertical-align:middle;}',
    ...
    '.footer-leaf{position:absolute;left:.34in;top:.15in;line-height:1;}',
